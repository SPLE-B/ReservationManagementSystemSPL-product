...
const ModifiedFormAddRatingForm = ({ 
	resourceListData
 }) => {
  const { 
    control, 
  ...
  return (
	...
	,
		  ...
		  itemsEvents={[
		    <Button id="_VJ0wkF2EEfGjCoBCLIsS7g" key="Save" type="submit" variant="primary">Save</Button>
	    ]}
	  />
...
export default ModifiedFormAddRatingForm
