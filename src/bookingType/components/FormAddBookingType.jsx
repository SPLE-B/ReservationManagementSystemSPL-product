...
const FormAddBookingType = ({ 
  ...
  return (
	...
	,
		  ...
		  itemsEvents={[
		    <Button id="_hZ9QI12FEfGjCoBCLIsS7g" key="Submit" type="submit" variant="primary">Submit</Button>
	    ]}
	  />
...
export default FormAddBookingType
